...
function timeout_error(): \WP_Error {
	return new \WP_Error('ba_search_query_timeout', __('This search took too long to run. Try a more specific search, or enter the value directly.', 'ba-search'), ['status' => 504]);
}